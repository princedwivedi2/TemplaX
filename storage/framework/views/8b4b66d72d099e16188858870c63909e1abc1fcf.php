...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'TemplaX')); ?></title>
    ...
    <body>
        <div class="container">
            <?php if(Route::has('login')): ?>
                <div class="auth-links">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="auth-link">Dashboard</a>
            ...
            <div class="footer">
                <p>&copy; <?php echo e(date('Y')); ?> TemplaX. All rights reserved.</p>
            </div>
        </div><?php /**PATH C:\wamp64\www\TemplaX\resources\views/welcome.blade.php ENDPATH**/ ?>