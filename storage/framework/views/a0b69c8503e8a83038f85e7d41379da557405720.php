    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h3 class="fw-bold mb-0"><?php echo e($userCards ?? 0); ?></h3>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('cards.create')); ?>" class="btn btn-primary">Create Card</a>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('cards.index')); ?>" class="btn btn-outline-primary">View Cards</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\TemplaX\resources\views/dashboard/index.blade.php ENDPATH**/ ?>